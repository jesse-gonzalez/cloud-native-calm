...
variable "rke_binary_url" {
  ...
  default     = "https://github.com/rancher/rke/releases/download/v1.3.11/rke_linux-amd64"
}
...
variable "image_url" {
  ...
  default     = "http://download.nutanix.com/calm/CentOS-7-x86_64-GenericCloud.qcow2"
