...
karbonctl registry add --name ${INSTANCE_NAME}_wildcard --url ${INSTANCE_NAME}.${WILDCARD_INGRESS_DOMAIN} --cert-file ~/.ssh/${INSTANCE_NAME}_wildcard_karbon_ca.crt --username admin --password @@{Artifactory Credential.secret}@@
monitor_registry_add_task
