...
class DeveloperWorkstation(Service):
    ...
    @action
    def InstallNodeJS(name="Install NodeJS"):
        CalmTask.Exec.ssh(
            name="Install NodeJS",
            filename="../_common/centos/scripts/install_nodejs.sh",
            cred=NutanixCred
        )
...
# class DeveloperWorkstationAhvVmResources(AhvVmResources):
...
# class DeveloperWorkstationAhvVm(AhvVm):

#     resources = DeveloperWorkstationAhvVmResources
...
class DeveloperWorkstationVM(Substrate):
    ...
    # provider_spec = DeveloperWorkstationAhvVm
    # provider_spec.name = "developer-workstation-@@{calm_unique}@@"
